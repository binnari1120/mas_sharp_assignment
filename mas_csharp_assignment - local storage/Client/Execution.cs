...
namespace Client
{
    internal class Execution
    {
        ...
        {
            // restful apis - request symbol constraints
            ...
            // restful apis - request transaction records
            ...
            // restful apis - request order records
        ...
        private void _load_positions()
        {
            ...
            try
            {
                ...
                else _positions = new ConcurrentDictionary<string, Position>();
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex);
        ...
        private void _load_orders()
        {
            ...
            try
            {
                ...
                else _orders = new ConcurrentDictionary<string, Order>();
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex);
        ...
        private void _read_transaction_records()
        {
            ...
            try
            {
                ...
                else _transaction_records = new List<TransactionRecord>();
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex);
        ...
        private void _read_order_records()
        {
            ...
            try
            {
                ...
                else _order_records = new List<OrderRecord>();
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex);
        ...
        public void update_position(OrderApplication order_application)
        {
            if (_positions.ContainsKey(order_application.symbol))
            {
                ...
                if (order_application.side == Side.BUY)
                {
                    ...
                    lock (_lock) Logger.log_object("active", "positions.txt", _positions.ToList());
                }
                else
                {
                    Position position = new Position
        ...
        public void update_order(OrderApplication order_application)
        {
            ...
            lock (_lock) Logger.log_object("active", "orders.txt", _orders.ToList());
        }
        ...
        public void update_transaction_record(OrderApplication order_application, ConcurrentDictionary<string, Orderbook> orderbooks)
        {
            ...
            lock (_lock)
            {
                ...
                Logger.log_object("records", "transactions.txt", _transaction_records);
            }
            ...
            lock (_lock)
            {
                Logger.log_object("active", "asset.txt", _asset);
            }
        }
        ...
        public void update_order_record(OrderApplication order_application)
        {
            ...
            lock (_lock)
            {
                ...
                Logger.log_object("records", "orders.txt", _order_records);
            }
        }
