...
namespace Client
{
    internal partial class FormOrderbook : Form
    {
        ...
        {
            Debug.WriteLine("===================== _on_form_orderbook_table_layout_panel_buttons_button_buy_clicked =====================");
        ...
        {
            Debug.WriteLine("===================== _on_form_orderbook_table_layout_panel_buttons_button_sell_clicked =====================");
        ...
        {
            Debug.WriteLine("===================== _on_form_orderbook_tab_control_status_data_grid_view_positions_cell_clicked =====================");
        ...
        {
            Debug.WriteLine("===================== _on_form_orderbook_tab_control_status_data_grid_view_orders_cell_clicked =====================");
